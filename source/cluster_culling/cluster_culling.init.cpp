...
bool ClusterCulling::Initialize(LPCTSTR mainWndCaption, uint32 screenWidth, uint32 screenHeight, bool fullscreen) {
	LoadSceneJson();
...
void ClusterCulling::LoadSceneJson() {
...
void ClusterCulling::InitTweakBar() {
...
void ClusterCulling::LoadShaders() {
