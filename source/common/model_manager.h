...
//
//public:
//	uint AddModel(const Model<Vertex> &model);
...
//
//template <typename Vertex>
//uint ModelManager::AddModel(const Model<Vertex> &model, uint verticesSize, uint indicesSize, bool isStatic = true) {
//	if (isStatic) {
...
//
//template <typename Vertex>
//void ModelManager::InitStaticBuffers() {
