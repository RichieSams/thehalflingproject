...
void SpriteRenderer::Render(ID3D11ShaderResourceView *texture, const DirectX::XMFLOAT4X4 &transform, const const DirectX::XMFLOAT4 &color, const const DirectX::XMFLOAT4 *drawRect) {
	assert(m_context);
	assert(m_initialized);
