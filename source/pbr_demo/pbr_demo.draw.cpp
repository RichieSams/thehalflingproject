...
void PBRDemo::ForwardRenderingPass() {
...
void PBRDemo::SetForwardVertexShaderObjectConstants(DirectX::XMMATRIX &worldMatrix, DirectX::XMMATRIX &worldViewProjMatrix) {
...
void PBRDemo::SetInstancedForwardVertexShaderFrameConstants(DirectX::XMMATRIX &viewProjMatrix) {
...
void PBRDemo::SetInstancedForwardVertexShaderObjectConstants(uint startIndex) {
...
void PBRDemo::SetForwardPixelShaderFrameConstants() {
...
void PBRDemo::SetForwardPixelShaderObjectConstants(const Common::BlinnPhongMaterial &material, uint textureFlags) {
...
void PBRDemo::DeferredRenderingPass() {
...
void PBRDemo::SetNoCullFinalGatherShaderConstants(DirectX::XMMATRIX &invViewProjMatrix) {
...
void PBRDemo::RenderDebugGeometry() {
	DirectX::XMMATRIX viewMatrix = m_camera.GetView();
	DirectX::XMMATRIX projectionMatrix = m_camera.GetProj();
...
void PBRDemo::SetRenderGBuffersPixelShaderConstants(DirectX::XMMATRIX &invViewProjMatrix, uint gBufferId) {
